console.log("%cScores Final Mundial Qatar 2022 - Selección Argentina", "background-color: #0096c7; color: white; font-size: 20px; text-align: center ; padding: 10px ;  margin: 5px ");
...
console.log("%cOutstanding Players & Scores", "background-color: #0096c7; color: white; font-size: 15px; text-align: center; padding:10px;margin: 5px");

console.table(outstandingPlayers)